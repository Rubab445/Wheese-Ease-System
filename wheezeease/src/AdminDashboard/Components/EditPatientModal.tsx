...
export default function EditPatientModal({ isOpen, patient, onClose }: EditPatientModalProps) {
  ...
  useEffect(() => {
    if (patient) {
      setFormData({
        ...
        knownTriggers: patient.knownTriggers?.join(', ') || '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Updating patient:', { id: patient.id, ...formData });
    alert(`Successfully updated ${formData.name}'s information!`);
    // TODO: API call to update patient
    onClose();
  };
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container edit-patient-modal" onClick={(e) => e.stopPropagation()}>
