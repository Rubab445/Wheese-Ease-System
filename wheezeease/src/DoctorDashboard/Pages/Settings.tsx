...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="wheeze-settings-app">
      <aside className="wheeze-sidebar">
        <div className="brand">
        ...
        <nav className="side-nav">
          <SettingsTab label="Profile" icon="fas fa-user-md" isActive={activeTab === 'Profile'} onClick={() => setActiveTab('Profile')} />
          <SettingsTab label="Notifications" icon="fas fa-bell" isActive={activeTab === 'Notifications'} onClick={() => setActiveTab('Notifications')} />
          <SettingsTab label="Security" icon="fas fa-shield-alt" isActive={activeTab === 'Security'} onClick={() => setActiveTab('Security')} />
          <SettingsTab label="Appearance" icon="fas fa-palette" isActive={activeTab === 'Appearance'} onClick={() => setActiveTab('Appearance')} />
          
          <div className="sidebar-footer-item">
             <i className="fas fa-cog"></i> System Prefs
          </div>
        </nav>
      </aside>
      ...
      <main className="settings-main">
        <header className="main-header">
          <div className="header-text">
            ...
            <p>Configure your personal identity and system-wide preferences.</p>
          </div>
            ...
            <div className="animate-fade">
              <div className="photo-section">
                ...
                <div className="photo-text">
                  ...
                  <p style={{ fontSize: '11px', color: '#7C3AED', marginTop: '4px' }}>
                    <i className="fas fa-info-circle"></i> JPG, PNG or GIF format
                  </p>
                </div>
              </div>
              ...
              <div className="sub-tab-nav">
                ...
                <button className={profileSubTab === 'Professional' ? 'active' : ''} onClick={() => setProfileSubTab('Professional')}>
                  <i className="fas fa-stethoscope"></i> Professional Record
                </button>
              </div>
